...
Rails.application.config.after_initialize do
  if defined?(WickedPdf::WickedPdfHelper::Assets)
    WickedPdf::WickedPdfHelper::Assets.module_eval do
      ...
      alias_method :wicked_pdf_stylesheet_pack_tag, :wicked_pdf_stylesheet_link_tag
      ...
      alias_method :wicked_pdf_javascript_pack_tag, :wicked_pdf_javascript_include_tag
    end
  end
end
