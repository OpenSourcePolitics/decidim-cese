...
module Decidim
  ...
  class Organization < ApplicationRecord
    ...
    has_one_attached :official_cachet
    validates_upload :official_cachet, uploader: Decidim::OfficialCachetUploader

    has_one_attached :official_signature
    validates_upload :official_signature, uploader: Decidim::OfficialSignatureUploader
