...
describe "Admin manages organization", type: :system do
  ...
  describe "edit" do
    ...
    it "updates the values from the form" do
      ...
      dynamically_attach_file(:organization_official_cachet, Decidim::Dev.asset("city3.jpeg"))
      dynamically_attach_file(:organization_official_signature, Decidim::Dev.asset("city3.jpeg"))
      ...
      within ".organization-images" do
        expect(page.all("img").count).to eq(6)
      end
    end
